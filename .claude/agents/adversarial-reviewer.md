...
description: Revisa un cambio con el objetivo de REFUTARLO. Contrasta contra la spec viva, el contrato y CLAUDE.md. Read-only.
...
(`fichero:línea` que hayas leído) y el escenario que se rompe. No edites archivos.
