...
| `q` de menos de dos caracteres, parámetro desconocido o repetido: `422` sobre ese campo                                               | Búsqueda híbrida · Consulta vacía                                              | `searchQuerySchema`, `parseQuery`                                         | `search.test.ts` · «una consulta de un carácter, un parámetro desconocido o repetido son 422...»                                                               |
...
| Si el texto cambia mientras se vectoriza, el trabajo lo repite                                                                        | Qué se vectoriza                                                               | `generateEmbeddingJob`                                                    | `embeddings.test.ts` (worker) · «si el texto cambia mientras se vectoriza...»                                                                                  |
