...
Una unidad de trabajo que una persona termina en una sesión, con media jornada como techo. **Hereda** los criterios de su historia; su Definition of Done es una checklist de *cómo entregamos*, no criterios nuevos ni estimación en horas. Nombra la capa que toca; **no diseña**: tipo de columna, índices, rutas y códigos se deciden al implementar. Se descompone solo la historia próxima: un ticket escrito con cinco historias de antelación caduca antes de abrirse.

## Matriz impacto / complejidad

**Impacto** = cuánto sirve a la promesa central: *pegas la URL, el sistema la entiende por ti, y la reencuentras preguntando en tu idioma*. **Complejidad** = esfuerzo relativo de construcción, no riesgo.
