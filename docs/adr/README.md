...
Los ADR 0001 a 0005 vienen del Harness-LDIR: registran decisiones que el proyecto de origen tomó después de pagar su ausencia, adaptadas a este stack. Los 0006 a 0011 son las del prompt maestro. El 0012 y el 0013 son de este proyecto.
...
| [0013](0013-sesion-propia-en-vez-de-authjs.md)                          | Sesión propia con token opaco en PostgreSQL, en vez de Auth.js, mientras solo haya credenciales | Aceptada |
