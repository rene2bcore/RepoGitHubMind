...
## Correspondencia con la plantilla de LIDR

El fork académico [`rene2bcore/AI4Devs-finalproject`](https://github.com/rene2bcore/AI4Devs-finalproject) lleva el `readme.md` y el `prompts.md` de la plantilla de LIDR rellenos, con todos sus encabezados y notas, y enlaza aquí para el detalle. Dónde vive cada sección en este repositorio:

| Sección de la plantilla                        | Aquí                                                                                                                                                                                                                                                                                                                                            |
| ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0. Ficha del proyecto                          | [Ficha del proyecto](#ficha-del-proyecto)                                                                                                                                                                                                                                                                                                       |
| 1.1 Objetivo · 1.2 Características             | [`docs/prd.md`](docs/prd.md) §1 a §4, [`docs/roadmap.md`](docs/roadmap.md)                                                                                                                                                                                                                                                                      |
| 1.3 Diseño y experiencia de usuario            | [`docs/evidencia/`](docs/evidencia/) (capturas a móvil y escritorio), [El flujo que se demuestra](#el-flujo-que-se-demuestra), requisitos «La interfaz SHALL» en [`docs/specs/`](docs/specs/)                                                                                                                                                   |
| 1.4 Instrucciones de instalación               | [Instalación](#instalación), [`docs/deployment-local.md`](docs/deployment-local.md)                                                                                                                                                                                                                                                             |
| 2.1 Diagrama de arquitectura · 2.2 Componentes | [`docs/architecture.md`](docs/architecture.md) (C4), [`docs/adr/`](docs/adr/), [`docs/capabilities/`](docs/capabilities/README.md)                                                                                                                                                                                                              |
| 2.3 Estructura de ficheros                     | [`CLAUDE.md`](CLAUDE.md) § Estructura                                                                                                                                                                                                                                                                                                           |
| 2.4 Infraestructura y despliegue               | [`docs/deployment-local.md`](docs/deployment-local.md), [`docs/deployment-hostinger.md`](docs/deployment-hostinger.md), [`.github/workflows/`](.github/workflows/)                                                                                                                                                                              |
| 2.5 Seguridad                                  | [`SECURITY.md`](SECURITY.md), [`docs/traceability.md`](docs/traceability.md) §2                                                                                                                                                                                                                                                                 |
| 2.6 Tests                                      | [`docs/estrategia-de-pruebas.md`](docs/estrategia-de-pruebas.md), [`docs/traceability.md`](docs/traceability.md), [`scripts/mutaciones.mjs`](scripts/mutaciones.mjs)                                                                                                                                                                            |
| 3. Modelo de datos                             | [`docs/data-model.md`](docs/data-model.md), [`packages/db/src/schema.ts`](packages/db/src/schema.ts), [`packages/db/migrations/`](packages/db/migrations/)                                                                                                                                                                                      |
| 4. Especificación de la API                    | [`docs/api/openapi.json`](docs/api/openapi.json) (generado desde Zod), [`docs/api/README.md`](docs/api/README.md)                                                                                                                                                                                                                               |
| 5. Historias de usuario                        | [`docs/backlog/`](docs/backlog/README.md), Jira `RGM`                                                                                                                                                                                                                                                                                           |
| 6. Tickets de trabajo                          | [`docs/backlog/RGM-2-cuentas-y-sesion.md`](docs/backlog/RGM-2-cuentas-y-sesion.md) (RGM-9 datos, RGM-10 backend, RGM-11 frontend)                                                                                                                                                                                                               |
| 7. Pull requests                               | [#4](https://github.com/rene2bcore/RepoGitHubMind/pull/4) H1, [#6](https://github.com/rene2bcore/RepoGitHubMind/pull/6) H2, [#7](https://github.com/rene2bcore/RepoGitHubMind/pull/7) H3; [#5](https://github.com/rene2bcore/RepoGitHubMind/pull/5) y [#8](https://github.com/rene2bcore/RepoGitHubMind/pull/8) salidos del revisor adversarial |
| `prompts.md` (máximo 3 prompts por sección)    | [`prompts.md`](prompts.md), con el prompt maestro íntegro como anexo, y [`docs/prompts/00-prompt-maestro.md`](docs/prompts/00-prompt-maestro.md)                                                                                                                                                                                                |
